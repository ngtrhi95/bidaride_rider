...
/**
 * Created by trhie on 7/10/2017.
 */

public class AT_Adapter extends
        RecyclerView.Adapter<AT_Adapter.PredictionHolder> implements Filterable{
    private static final String TAG = "PlacesAutoCompleteAdapter";
    private ArrayList<PlaceAutocomplete> mResultList;
    private GoogleApiClient mApiClient;
    private LatLngBounds mBounds;
    private AutocompleteFilter mACFilter;
    ...
    private ArrayList<PlaceAutocomplete> getAutocomplete(CharSequence constraint) {
        if (mApiClient.isConnected()) {
            ...
            PendingResult<AutocompletePredictionBuffer> results =
                    Places.GeoDataApi
                            .getAutocompletePredictions(mApiClient, constraint.toString(),
                                    mBounds, mACFilter);
    ...
    public void onBindViewHolder(PredictionHolder mPredictionHolder, final int i) {
        CharSequence a = mResultList.get(i).description;
